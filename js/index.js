$(function () {
    ...
    //about service 资料卡的实现
    $('.teamcom ul li').click(function(event){
        var index = $(this).index()
        var changediv = $('.teamcom').children('div').eq(index)
        ...
        changediv.siblings('div').removeClass('active')
        changediv.siblings('div').css('display','none')
    })
